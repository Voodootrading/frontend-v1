...
const ProjectArea = () => {
  const [category, setCategory] = React.useState("This Week");
        ...
        <div className="row align-items-center mb-15">
          <div className="col-xl-5 col-lg-12 col-md-12">
            <div className="tp-project-section-box">
              <h5 className="tp-subtitle">Schedule Plan</h5>
              <h2 className="tp-title">Upcoming Events. </h2>
            </div>
          </div>
                  ...
                  <div className="tp-project-content ml-20">
                    ...
                    <Link href={`/portfolio-details/${item.id}`}>
                      <a className="tp-btn-sm">
                        Book Event Slot<i className="far fa-arrow-right"></i>
                      </a>
                    </Link>
                  </div>
                </div>
